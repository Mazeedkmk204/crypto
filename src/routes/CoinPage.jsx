        ...
        <div>
          ...
          <div className="flex justify-between py-4 ">
            ...
            <div>
              ...
              {coin.tickers ? <p>{coin.tickers[0].trust_score}</p> : null}
            </div>
          </div>
          <div className="flex justify-between py-4">
            <div>
              <p className="text-gray-500 text-sm">Price Chnage (24h)</p>
              {coin.market_data ? (
                <p>
            ...
            <div>
              <p className="text-gray-500 text-sm">Price Chnage (7d)</p>
              {coin.market_data ? (
                <p>{coin.market_data.price_change_percentage_7d.toFixed(2)}%</p>
              ) : null}
            </div>
            <div>
              <p className="text-gray-500 text-sm">Price Chnage (14d)</p>
              {coin.market_data ? (
                <p>
